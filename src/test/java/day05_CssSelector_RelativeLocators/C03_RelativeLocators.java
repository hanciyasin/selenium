...
public class C03_RelativeLocators {
    public static void main(String[] args) {
        ...
        String actualBerlinID = berlin.getAttribute("id");
        String expectedBerlinID = "pid7_thumb";

        if (actualBerlinID.equals(expectedBerlinID)){
            System.out.println("TEST PASSED");
        }else {
            System.out.println("TEST FAILED");
        }
        System.out.println(actualBerlinID);
        System.out.println(expectedBerlinID);
